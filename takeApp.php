...
$path = 'http://localhost/myproj/Freedownloadr1/uploadedApp/';
$pathforMovingFiles = 'C:/xampp/htdocs/myproj/freedownloadr1/uploadedApp/';
$_POST['appName'];
...
$result = move_uploaded_file($appFile, $pathforMovingFiles.$appName);
$result = move_uploaded_file($thumbnailFile, $pathforMovingFiles.$thumbnailName);
